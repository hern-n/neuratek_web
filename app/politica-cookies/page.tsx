      ...
      <section className="relative pt-32 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-neuratek-primary text-sm font-medium uppercase tracking-widest">{dict.politicaCookies.label}</span>
          </div>
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 flex items-center gap-3">
            ...
            {dict.politicaCookies.title}
          </h1>

          <div className="space-y-8 text-white/80 leading-relaxed">
            {dict.politicaCookies.sections.map((section, index) => (
